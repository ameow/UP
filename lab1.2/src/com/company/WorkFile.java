...
public class WorkFile {
    ...
    public void writeFile(List<Message> listMessage) {
        try {
            ...
            System.out.println("Произошла ошибка  записью в файл Output.json");
        }
    }
    ...
    public List<Message> readFile(String filename) {
        ...
        try {
            ...
            System.out.println("Произошла ошибка с чтением из файла");
        }
    ...
    public void writeLogfile(String string) {
        try {
            ...
            System.out.println("Произошла ошибка с открытием файла logfile.txt");
        }
    }
